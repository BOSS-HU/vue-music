  ...
  <div class="player" v-show="playlist.length>0">
    ...
    <transition name="mini">
      <div class="mini-player" v-show="!fullScreen" @click="open">
        <div class="icon">
          <img :class="imageRotate" :src="currentSong.image" width="40" height="40" alt="">
        </div>
        <div class="text">
...
//          let percent = this.currentTime / totalTime
//          return totalTime ? percent : 0
//        }
//      },
      ...mapGetters([
        'fullScreen',
    ...
    watch: {
      currentSong(newSong, oldSong) {
        ...
        this.$nextTick(() => {
          ...
          this.currentSong.getLyricWraper()
        })
      },
      playing(newPlaying) {
      ...
      currentTime() {
        let totalTime = this.currentSong.duration
        if (totalTime && totalTime > 0) {
          this.percent = this.currentTime / totalTime
          return totalTime ? this.percent : 0
        }
      }
    },
    components: {
    ...
    methods: {
      ...
      formatTime(time) {
        let min = time / 60 | 0
        let sec = time % 60 | 0
        return min + ':' + this._twoDigits(sec)
      },
      ...
      _getPosAndScale() {
        ...
        const selfPaddingTop = 80
        const selfWidth = window.innerWidth * 0.8
        const scale = targetWidth / selfWidth
        const x = -(window.innerWidth / 2 - paddingLeft)
        const y = window.innerHeight - selfPaddingTop - selfWidth / 2 - paddingBottom
        return {
          x,
          y,
          scale
